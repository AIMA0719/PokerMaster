 ...
 *
 * 본 테스트는 Team Rules + Team Process 통합 시나리오 확인용으로 비활성(@Disabled) 상태로 둔다.
 * 활성화 시 다음 항목을 확인:
 *
 *  - 2인 헤즈업: 7th 베팅 종료 → Street.DECLARE 진입
 *  - ActionType.DECLARE + Declaration payload 직렬 적용 → Street.SHOWDOWN 자동 전이
